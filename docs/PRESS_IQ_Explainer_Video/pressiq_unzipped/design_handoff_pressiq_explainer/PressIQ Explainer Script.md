# PressIQ Explainer Video Script
**Version:** 1.1 (reviewed + corrected) | **Target runtime:** ~3.5–4.5 min | **Date:** 2026-06-24

**Intended uses:**
1. Embedded demo on `/tools/pressiq`
2. Resources section — Videos category
...
| Element | Spec |
|---|---|
| Screen recording | Live tool walkthrough at syedirfanajmal.com/tools/pressiq |
| Talking head | Optional — works as pure VO + screen record |
| Lower thirds | Tool name "PressIQ", stat sources on each data callout |
| Music | Understated instrumental — no beats, no drama |
| Captions | Required (LinkedIn autoplay is muted) |
| Aspect ratios | 16:9 for YouTube; 1:1 or 4:5 crop for LinkedIn |
...
**VISUAL:** Black screen. Single stat fades in, large text.
...
**VISUAL:** Montage — someone typing a pitch, hitting send, inbox icon, delete icon. No faces needed, just the motion.
...
**VISUAL:** Navigate to syedirfanajmal.com/tools/pressiq. Tool loads — show the dark left panel, the cream right panel, the headline "Will a journalist paste this in?"
...
**VISUAL:** Type a pitch into the input. Watch the left panel live metrics update in real time — word count ticking up, subject line length shown, reading grade calculating, closing question detected, tone indicator.
...
**VISUAL:** Click "Score this pitch." Loading state — pulsing yellow dots. Result appears: score number in large serif type, color-coded tier badge. Then: "Your strongest line" pull quote highlighted in yellow. Then: a bar chart — seven dimensions, each with a score and a color-coded bar.
...
**VISUAL:** Scroll into the Breakdown tab — expandable dimension blocks open one by one, showing sub-signal chips (green ✓ and red ✗) and evidence cards. Show them in the same order as the tool.
...
**SIA 7-Step Checklist** — 7 steps across research, subject line, intro, answer, story, evidence, and sign-off. 32 sub-signals total. The full outreach protocol in one pass.
...
**VISUAL:** Click to "Top Fixes" tab. Three fix cards appear — each with a specific, actionable instruction.
...
**VISUAL:** Scroll to Evidence tab. Research source cards visible — Cision, Muck Rack, Propel, Backlinko, Fractl, Boomerang.
...
**VISUAL:** Return to the tool home state. URL visible. Optional: Irfan on camera for the final line.
...
*Script by: Claude (Cowork) | For use on SIA site, YouTube, LinkedIn*
