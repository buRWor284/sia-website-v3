        ...
        <div className="grid-cards-3" style={{ border: `1px solid ${INK}` }}>
          {items.map((kit, i) => (
            <a
              ...
              rel={kit.href.startsWith("http") ? "noopener noreferrer" : undefined}
    ...
    >
      ...
      <div className="grid-intro">
        ...
        <div>
          ...
          >
            <SCaps size={10.5} ls="0.18em" color={YEL}>
              Browse the archive
            </SCaps>
            <p
              style={{
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            {[
              ...
              <a
                ...
                rel={
                  p.href !== "#" ? "noopener noreferrer" : undefined
                }
                style={{
                  padding: "10px 16px",
        ...
        >
          {items.map((ig, i) => (
            ...
            >
              ...
              >
                <SCaps size={12} ls="0.06em" color={INK70}>
                  Nº {ig.no}
                </SCaps>
              </div>
              {/* Content */}
