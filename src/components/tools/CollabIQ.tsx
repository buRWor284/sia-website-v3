...
function primaryBtn(): React.CSSProperties {
  return { display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 8,
    ...
    // a11y: near-black ink on amber (~10:1). Cream/white on amber failed WCAG AA (~1.9:1).
        ...
        <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
          <div style={{ maxWidth: 440, width: "100%", padding: "18px 20px", background: cBg2, borderLeft: `3px solid ${ACC}` }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              {/* 2026-07-11: swapped the old LinkedIn-post-screenshot crop
                  (1866x918, not a headshot) for the real headshot Irfan
                  provided from the sia-website-v3 assets folder. */}
              <img src="/assets/testimonials/azzam-sheikh.jpeg" alt="Azzam Sheikh" style={{ width: 44, height: 44, borderRadius: "50%", border: `1px solid ${cBd}`, objectFit: "cover", flexShrink: 0 }} />
        ...
        {selNiches.length > 0 && (
          <div style={{ marginTop:14 }}>
            ...
            <div style={{ display:"flex", flexWrap:"wrap", gap:6 }}>
              {selNiches.map(n=>(
                // a11y chip: dark fill + white text (~17:1) with an amber dot for brand.
                // Prev amber-on-pale-amber failed WCAG AA (~1.7:1).
