...
const ITEMS: ReadonlyArray<{ id: string; label: string }> = [
  ...
  { id: "the-payoff", label: "§ 6 · The Payoff" },
  { id: "how-it-works-detail", label: "§ 7 · What You'll Build" },
  { id: "tools", label: "§ 8 · Tools" },
  { id: "five-returns", label: "§ 9 · 5 Returns" },
  { id: "curriculum", label: "§ 10 · Curriculum" },
  { id: "proof", label: "§ 11 · Proof" },
  { id: "fit", label: "§ 12 · Fit Check" },
  { id: "calculator", label: "§ 13 · The Math" },
  { id: "pricing", label: "§ 14 · Investment" },
  { id: "guarantee", label: "§ 15 · Guarantee" },
  { id: "faq", label: "§ 16 · FAQ" },
];
