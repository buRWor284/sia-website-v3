 ...
 *
 * Also hidden on /emos/apply and /emos/pay: each ships its own standalone
 * `emos-nav` ("EMOS · Back to overview"), so the global header would stack on
 * top of it. The main /emos landing has NO nav of its own and DOES need the
...
const HIDDEN_PREFIXES = ["/emostool", "/sign-in", "/sign-up", "/clients/resourcex", "/emos/apply", "/emos/pay"];
