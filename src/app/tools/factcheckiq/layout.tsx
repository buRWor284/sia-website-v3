...
// explainer for a platform-only tool — no working FactcheckIQ logic here.
export const metadata: Metadata = {
  title: "FactcheckIQ · How It Works",
  description:
    "Catch the made up statistic before your reader does. See how FactcheckIQ's 10-step verification pipeline turns a raw draft into a graded, sourced fact-check report. Available inside the EMOS Platform.",
  openGraph: {
    title: "FactcheckIQ · How It Works",
    description:
