...
export default function PressIQPage() {
  ...
  // Turnstile widget re-arms without a page reload. Loop-safe: the core holds
  // onStepChange in a ref (see PressIQToolCore), so the inline callback's
  // changing identity can never re-trigger the step effect.
