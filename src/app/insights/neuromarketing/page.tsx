    ...
    <div style={{ background: PAPER, fontFamily: SERIF, color: INK }}>
      ...
      <section style={{ padding: "72px 56px", background: PAPER2 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 32, marginTop: 40 }}>
          {[
            { title: "Continue reading", body: "Explore the other guides — Personal Branding, Storytelling, and Writing Tips — to round out your marketing toolkit.", cta: "Back to Writing", href: "/writing" },
