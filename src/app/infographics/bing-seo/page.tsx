  ...
  return (
    <div style={{ background: PAPER, fontFamily: SERIF, color: INK }}>
      ...
      <section style={{ padding: "40px 56px 8px" }}>
        <SectionMast n="03" label="Editor's note · 2026" />
        <div style={{ maxWidth: 760 }}>
          <p style={{ ...P, padding: "20px 24px", background: PAPER2, border: `1px solid ${INK35}`, fontSize: 16.5, color: INK70, lineHeight: 1.6 }}>
