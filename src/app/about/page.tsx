...
const Hero = () => (
  <section className="sx" style={{ background: PAPER, paddingTop: 40, paddingBottom: 60 }}>
    <div style={{ textAlign: "center", marginBottom: 26 }}>
      <SCaps color={INK70} size={12} ls="0.28em">Filed by the Editor</SCaps>
    </div>
    <h1
      className="hero-h1"
      style={{
