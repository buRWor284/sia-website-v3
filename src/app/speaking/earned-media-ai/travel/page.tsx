...
import { TESTIMONIALS_TRAVEL } from "../testimonials";
import {
  DoubleRule,
  HRule,
  Mark,
...
// Caption rule: name a venue only where it is verified. The G-Day X and Arabian
// Travel Market banners are visible in their own frames. The IK Institute of
// Business venue was confirmed by Irfan 2026-07-30 and matches the Past Stages
// inventory on /speaking (IK Institute of Business, Dubai, 2016).
...
const FORMATS: ReadonlyArray<Fmt> = [
  {
    ...
    body: "A fast, story-led mainstage talk with a live “what does AI say about your destination?” moment. Best to open or close a track.",
  ...
  },
  {
    ...
    body: "I bring the live data and the contrarian takes, you bring the co-panelists. Happy to take the moderator seat instead. Best for a debate on AI, PR and destination marketing.",
  ...
  return (
    <div style={{ background: PAPER, fontFamily: SERIF, color: INK }}>
      ...
      <SpeakingTestimonials
        ...
        standfirst="Three people who booked the session or hosted it, including the organiser of a Dubai summit who works in travel himself. More on the flagship session page."
      />
      <BottomCTA />
      <CTATicker />
