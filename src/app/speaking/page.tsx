  ...
  <section className="sx" style={{ paddingTop: 36, paddingBottom: 40 }}>
    ...
    <div className="grid-hero-2col" style={{ alignItems: "stretch" }}>
      ...
      <aside style={{ background: PAPER2, border: `1px solid ${INK}`, padding: "20px 22px" }}>
        ...
        <a href="/press-kit" style={{ marginTop: 8, display: "block", textAlign: "center", padding: "12px 16px", background: PAPER, color: INK, border: `1px solid ${INK}`, textDecoration: "none", fontFamily: GROT, fontWeight: 800, fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase" }}>View the full press kit →</a>
      </aside>
    </div>
  </section>
);
