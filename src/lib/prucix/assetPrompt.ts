/**
 * Prucix — asset-pack generation. One structured tool-use call turns an
...
/** Deterministic "why Prucix flagged this" breakdown — honest, from our own components. */
export function buildSignalChart(opp: Opportunity): ChartSpec {
  const c = opp.components;
  return {
    type: "bar",
    title: "Why Prucix flagged this",
    ...
    caption: "Prucix's own signal breakdown — not journalist-facing data. Build the linkable asset above for that.",
  };
}
