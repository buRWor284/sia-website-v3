/**
 * Prucix — shared types for the proactive-PR / newsjacking tool.
 * Working name "Prucix" (rename in ONE place: PRODUCT in config.ts).
 * See Prucix-RFP.md for the full spec.
 *
