/**
 * Prucix — config-as-code. Tune beats, scoring weights, bands, gating, and the
...
export const PRODUCT = "Prucix";

/** Model for asset-pack generation (env-overridable). Mirrors PressIQ. */
export const PRUCIX_MODEL = process.env.PRUCIX_MODEL || "claude-sonnet-4-6";
