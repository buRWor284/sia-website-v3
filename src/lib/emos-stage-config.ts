...
export const STAGE_META: Record<EmosStage, {
  ...
  collab:   {
    ...
    description: "Find journalists by beat and coverage fit. Save the ones who fit, with a note on why.",
  ...
  coverage: {
    ...
    description: "Log your pitches and placements in one place, with each outlet's authority.",
