  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td align="center">
    <table role="presentation" width="440" cellpadding="0" cellspacing="0" style="background:#e8e0cc;border:1px solid #1a1410;">
      ...
      <tr><td style="padding:28px 28px 8px;">
        ...
        <p style="font-size:15px;color:rgba(26,20,16,.66);line-height:1.55;margin:10px 0 20px;">Enter this code in the tool to unlock your download. It expires in ${minutes} minutes.</p>
