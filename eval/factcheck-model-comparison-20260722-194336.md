...
Generated: 2026-07-22T14:43:36.392Z
...
| wb-09 | verified | unverifiable | MISS | unverifiable | MISS |
...
| --- | --- | --- | --- |
| Opus 4.8 (`claude-opus-4-8`) | 3/5 (60%) | 16 | $0.6685 |
| Sonnet 5 (`claude-sonnet-5`) | 1/3 (33%) | 18 | $0.5512 |

Incomplete (check_failed, excluded from accuracy): Opus 4.8 0, Sonnet 5 2.

## Token usage

| Model | Input | Cache read | Cache write | Output | Web searches |
| --- | --- | --- | --- | --- | --- |
| Opus 4.8 | 2968 | 305684 | 17232 | 9324 | 16 |
| Sonnet 5 | 139250 | 204442 | 22039 | 10675 | 7 |
