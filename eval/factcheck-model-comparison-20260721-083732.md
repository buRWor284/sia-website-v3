...
Generated: 2026-07-21T03:37:32.661Z
...
| wb-08 * | unverifiable | partly_accurate | MISS | check_failed | skip |
...
| --- | --- | --- | --- |
| Opus 4.8 (`claude-opus-4-8`) | 3/4 (75%) | 9 | $0.3906 |
| Sonnet 5 (`claude-sonnet-5`) | 1/1 (100%) | 0 | n/a |

Incomplete (check_failed, excluded from accuracy): Opus 4.8 1, Sonnet 5 4.

## Token usage

| Model | Input | Cache read | Cache write | Output | Web searches |
| --- | --- | --- | --- | --- | --- |
| Opus 4.8 | 2305 | 113144 | 16823 | 5096 | 9 |
| Sonnet 5 | 0 | 0 | 0 | 0 | 0 |
