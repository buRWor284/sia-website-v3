...
Generated: 2026-07-21T11:00:50.232Z
...
| --- | --- | --- | --- | --- | --- |
| wb-01 * | verified | verified | ok | check_failed | skip |
| wb-08 | unverifiable | partly_accurate | MISS | partly_accurate | MISS |
...
| --- | --- | --- | --- |
| Opus 4.8 (`claude-opus-4-8`) | 2/4 (50%) | 12 | $0.5605 |
| Sonnet 5 (`claude-sonnet-5`) | 1/2 (50%) | 13 | $0.4536 |

Incomplete (check_failed, excluded from accuracy): Opus 4.8 1, Sonnet 5 3.

## Token usage

| Model | Input | Cache read | Cache write | Output | Web searches |
| --- | --- | --- | --- | --- | --- |
| Opus 4.8 | 2315 | 220238 | 19664 | 7836 | 12 |
| Sonnet 5 | 49175 | 247550 | 29861 | 11107 | 12 |
